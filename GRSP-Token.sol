...
/**
 * Contract GreenSproutToken: Read: _decimals, decimals, _name, name, _symbol, symbol, allowance, balanceOf, totalSupply; Write:  transfer, transferFrom, approve, decreaseAllowance, increaseAllowance.
 ...
 * Contract Token Buy, Sell, Transfer Tax.
 * Contract WhiteList.
 */
...
contract SwapBlock is Ownable {
    ...
    function setTaxBuy(uint256[] memory _percentsTaxBuy, address[] memory _addressesTaxBuy) public onlyOwner {
        ...
        require(TaxSum <= 2, "TaxSum > 2"); // Set the maximum tax limit
...
contract GreenSproutToken is Context, Ownable, IERC20, SwapBlock, BlackList, WhiteList {
    using SafeMath for uint256;
